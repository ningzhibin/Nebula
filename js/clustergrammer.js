...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = function make_config(args) {
	  ...
	  if (!utils.is_undefined(args.order) && utils.is_supported_order(args.order)) {
	    ...
	    // Row/col are swapped in the viz: inst_order.row drives horizontal (column) order and
	    // the "Column Order" sidebar buttons highlight against inst_order.row — default to alpha.
	    config.inst_order.row = 'alpha';
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = function ini_sidebar(cgm) {
	  ...
	  // gene_search_box removed — replaced by custom Find & Highlight panel; skip Awesomplete init
...
/***/ (function(module, exports) {
	...
	module.exports = function set_up_search(sidebar, params) {
	  ...
	  var section = sidebar.append('div')
	    .classed('find_hl_section', true)
	    .style('padding', '8px 10px 10px')
	    .style('border-top', '1px solid #dde2ea')
	  ...
	  // ── Rows ──
	  section.append('div')
	    .classed('find_hl_axis_label', true)
	  ...
	  section.append('textarea')
	    .attr('id', 'find-row-input')
	    .classed('find_hl_textarea', true)
	    .style('width', '100%')
	    ...
	    .attr('placeholder', 'e.g. TP53, EGFR\n(partial match, case-insensitive)');

	  section.append('div')
	    .attr('id', 'find-row-count')
	    .style('font-size', '10px')
	    .style('color', '#888')
	  ...
	  section.append('textarea')
	    ...
	    .style('min-height', '42px')
	    .style('max-height', '110px')
	    .attr('placeholder', 'e.g. Sample1, Control\n(partial match, case-insensitive)');

	  section.append('div')
	    .attr('id', 'find-col-count')
	    .style('font-size', '10px')
	    .style('color', '#888')
	    .style('min-height', '14px')
	    .style('margin-top', '2px');
	  ...
	  // ── Action buttons ──
	  var btn_row = section.append('div')
	    .style('display', 'flex')
	    .style('gap', '4px')
	    .style('margin-top', '7px');

	  btn_row.append('button')
	    .attr('id', 'find-filter-btn')
	    .attr('title', 'Re-render heatmap showing only matched rows/columns')
	    .style('flex', '1')
	    .style('font-size', '10px')
	    .style('padding', '3px 0')
	  ...
	  btn_row.append('button')
	    .attr('id', 'find-restore-btn')
	    .attr('title', 'Restore full view')
	    .style('display', 'none')
	    .style('font-size', '10px')
